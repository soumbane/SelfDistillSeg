...
class SelfDistilUNETR(nn.Module):
    ...
    def forward(self, x_in):
        ...
        # Upsample Encoder 1 (Just use Unetout block to reduce channels; Upsample with Deconv NOT needed)
        out_1 = self.out(enc1) 
        # print(f"Encoder 1 shape after upsampling: {out_1.shape}")''' 
        ...
        # print(f"Decoder 0 upsampled shape: {out_dec1.shape}")
