"""
Main training script to train a UNETR with Deep Supervision ONLY on MMWHS Challenge dataset for CT ONLY
"""
...
if __name__ == "__main__":
    ...
    manager = Manager.from_checkpoint("experiments/CT_Dice_Loss_challenge_data_DeepSuperOnly.exp/best.model") # for Deep Supervision ONLY
